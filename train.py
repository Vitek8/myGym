...
def configure_env(arg_dict, model_logdir=None, for_train=True):
    if arg_dict["engine"] == "pybullet":
        env_arguments = {"render_on": True, "visualize": arg_dict["visualize"], "workspace": arg_dict["workspace"],
                         ...
                         "task_objects":arg_dict["task_objects"], "distractor":arg_dict["distractor"], "reward_type": arg_dict["reward_type"],
...
def get_parser():
    ...
    parser.add_argument("-di", "--distractor", type=str, help="Object (for reach) to evade")
